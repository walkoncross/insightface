...
nohup python extract_features_for_aligned_imagelist.py \
    --model=/disk2/zhaoyafei/face-model-packages/face-insight/model-r100-ms1m-zyf-0221/slim/model-r100-slim,40 \
    ...
    --save-dir=/disk2/data/FACE/face-idcard-1M/features/insightface-r100-ep40-zyf \
    --batch-size=180 \
    --image-size=3,112,112 \
    --add-flip \
    --gpu=1 \
    --save-format=.bin \
    --flip-sim > nohup-extract-log-r100-ep40.txt &
